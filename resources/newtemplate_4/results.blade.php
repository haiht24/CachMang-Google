...
@section('content')
    ...
    <div class="row" style="margin-left:0px;margin-right:0px">
        <div class="s-result col-lg-{{$col_left}} col-md-{{$col_left}} col-sm-{{$col_left}} col-xs-12">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:10px;text-align:left">
            @if(!empty($related))
                <div class="pnel">
