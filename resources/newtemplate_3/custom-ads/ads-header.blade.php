...
<div class="panel panel-default" style="overflow:hidden">
	<div class="panel-body">
		...
		<span class="btn btn-warning  pull-left discount-value" style="margin-right:10px;"><h3>{{ str_limit(html_entity_decode($result['title']),80) }}</h3></a></strong>  <span class="fa fa-external-link"></span><br/>
		<p>
