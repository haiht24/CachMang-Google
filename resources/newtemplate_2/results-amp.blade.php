            ...
            <div class="col-md-8 col-xs-12">
                ...
                <p>Share:
                    <a target="_blank"
                       ...
                       title="Facebook Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/fb.png"></amp-img></a>
                    <a target="_blank"
                       href="https://plus.google.com/share?url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="Google Plus Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/gp.png"></amp-img></a>
                    <a target="_blank"
                       href="https://twitter.com/share?url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="Twitter Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/tw.png"></amp-img></a>
                    <a target="_blank"
                       href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="LinkedIn Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/in.png"></amp-img></a>
                    <a target="_blank"
                       href="https://pinterest.com/pin/create/button/?url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="Pinterest Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/pin.png"></amp-img></a>
                    <a target="_blank"
                       href="http://www.stumbleupon.com/badge/?url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="StumbleUpon Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/su.png"></amp-img></a>
                    <a target="_blank"
                       href="https://www.reddit.com/submit?url={{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="Reddit Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/rt.png"></amp-img></a>
                    <a target="_blank"
                       href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site {{ 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] }}"
                       title="E-Mail Share"><amp-img width="25px" height="25px"  src="{{ url('/') }}/images/mail.png"></amp-img></a>
                </p>
                @if(ENABLE_SEARCH_BOX)
                    <form class="form-inline" role="form" method="get" id="frmSearch" autocomplete="off" action="/" target="_top">
