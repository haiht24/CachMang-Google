...
<div class="search-form row" style="text-align:center;margin-top:180px;margin-bottom:180px">
...
//                    }
    ...
    $(document).ready(function () {
        ...
        function search() {
			...
			--}}
            var kw = q.replace(/\s/g,'-').replace(',','').toLowerCase();

            if('{{ USE_DEFAULT_KEYWORD }}' == '1'){
                var defaultKw = '{{ env('KEYWORD') }}';
