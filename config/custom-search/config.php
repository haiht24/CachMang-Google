...
return [
    'udemy-coupons' => [
        'cpd' => [
            'url' => 'https://couponsplusdeals.com/udemy-coupons',
            'title' => '75% Off udemy.com Coupons & Promo Codes, February 2019',
            ...
            'extend_url' => [
                [
                    ...
                    'description' => 'Savings to love! Courses start at just $11.99.'
                ], [
                    'title' => '2019 Best Free Udemy Coupons',
                    'description' => 'Get 100% off Udemy coupon code & save!'
                ], [
                    'title' => '2500+ courses $10-$15',
                    'description' => 'Courses On Entrepreneurship, Sql, Finance, Data Analysis & More.'
                ],
            ]
        ],
        'bbbd' => [
        ...
        'mrt' => [
            ...
            'title' => '70% Off udemy.com Coupons &amp; Promo Codes, February 2019',
            'description' => 'Udemy is a global marketplace for learning and teaching online where students are able to master new skills and achieve their goals by learning from an ...'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/udemy-coupons',
            'title' => '100% Off udemy.com Coupons &amp; Promo Codes, February 2019',
            'description' => 'Receive up to 50% OFF during shopping with Udemy coupon codes. Take chance!'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/udemy-coupons',
            'title' => '100% Off udemy.com Coupons &amp; Promo Codes, February 2019',
            'description' => 'Udemy Business Course Offers: Get all courses For $10 @ Udemy. Use Exclusive Udemy promo code at checkout to avail discount. Valid on popular courses ...'
        ]
    ],
    'alidropship-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/alidropship-coupons',
            'title' => '80% Off AliDropship Coupons & Promo codes - Coupons Plus Deals',
            'description' => 'Save with AliDropship Coupons & Promo codes coupons and promo codes for February, 2019. Today\'s top AliDropship Coupons & Promo codes discount: ...',
            'extend_url' => [
                [
                    'title' => 'Exclusive Coupons And Deals‎',
                    'description' => 'Reach up to 1000% ROI with your Dropship Store. Buy with a discount!'
                ], [
                    'title' => 'Discount Up to 35%',
                    'description' => 'Just $299 for a basic package, and more...'
                ], [
                    'title' => 'AliDropship Plugin only $89',
                    'description' => 'Get the Most Powerful Plugin for Dropshipping Businesses!'
                ], [
                    'title' => 'Best sales 2019',
                    'description' => 'Start from $2 per product data entry'
                ],
            ]
        ],
        'bbbd' => [
        ...
        'mrt' => [
            ...
            'title' => '65% Off alidropship.com Coupons & Promo Codes, February 2019',
            'description' => 'These deals are only available for a limited time! What you need is using our AliDropship Coupons coupon right now to enjoy amazing savings. STARTUPW15.'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/alidropship-coupons',
            'title' => 'Get 55% off a ready custom store with AliDropship coupon code',
            'description' => 'Click to save big with 7 latest 2019 Alidropship.com coupon & promo codes. Check out the best Alidropship.com coupon & promo codes of February 2019 now.'
        ],
        'cp' => [
    ...
    'active-campaign-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/active-campaign-coupons',
            'title' => 'Active Campaign Coupons & Promo codes - Coupons Plus Deals',
            'description' => 'If you worry for finding limited good-choices for your beloved person, cheer up as Active Campaign brings to you an extensive collection of great products with ...',
            'extend_url' => [
                [
                    'title' => 'Top ActiveCampaign coupon',
                    'description' => 'Try it free. No credit card required. Instant set-up.'
                ], [
                    'title' => '80% discount off',
                    'description' => 'Only pay $129 to get Professional Package'
                ], [
                    'title' => 'Best Coupons Site',
                    'description' => 'Coupons Plus Deals has a source of coupons and deals provided by users and visitors daily'
                ], [
                    'title' => 'Free Trials, Discounts, Coupon Codes',
                    'description' => 'Click & get code now. 100% working'
                ],
            ]
        ],
        'bbbd' => [
        ...
        'mrt' => [
            ...
            'title' => '50% Off activecampaign.com Coupons & Promo Codes, Updated 2019',
            'description' => 'Today\'s top ActiveCampaign coupon: Pay as low as $9/month for 0-500 Subscribers. Get 14 coupons for 2019. More coupons are updating! Take them now!'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/active-campaign-coupons',
            'title' => '55% Off Active Campaign Coupons, Discount & Promo code today',
            'description' => 'Save BIG with these awesome Active Campaign discounts now. Get up to 50% OFF for all items right now. You simply can\'t pass it, don\'t wait no more!'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/active-campaign-coupons',
            'title' => 'Never miss 50% Off Active Campaign Coupons & Promo - Click here!',
            'description' => '2019 Activecampaign.com Coupons: Save 10% with our 1+ Active Campaign.com coupon codes, promo codes, deals and offers | Tested Today! Hurry up!'
        ]
    ],
    'kats-naturals-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/kats-naturals-coupons',
            'title' => '30% Off katsnaturals.com Coupons & Promo Codes, Lastest 2019',
            'description' => 'Get the best Kat\'s Naturals coupon codes and promo codes at CouponsPlusDeals. Click to enjoy the latest deals and coupons of Kat\'s Naturals now!',
            'extend_url' => [
                [
                    'title' => 'Daily Deals for February!',
                    'description' => 'Lastest Kat\'s Naturals coupon & discount code. Update daily.'
                ], [
                    ...
                    'description' => 'You can find this Kat’s Naturals coupon codes at a reliable address-CouponsPlusDeals'
                ],
            ]
        ],
        'bbbd' => [
        ...
        'mrt' => [
            ...
            'title' => 'Kat\'s Naturals Coupons [verified] | 55% Off All CBD Products 2019',
            'description' => '20% off Kat\'s Naturals Coupons 2019. Go through Kat\'s Naturals Review and Kat\'s Naturals Promo Codes on couponmarathon.com to grab the best offers'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/kats-naturals-coupons',
            'title' => '45% Off Kats Naturals Coupon Codes 2019 | Discounts for February',
            'description' => 'If you are looking to start the CBD oil route and are searching for a quality product, Kat\'s Naturals is an excellent place to start. Find out why ...'
        ],
        'cp' => [
    ...
    'shootingtargets7-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/shootingtargets7-coupons',
            'title' => 'ShootingTargets7 Coupons & Promo codes - Coupons Plus Deals!',
            'description' => 'Shootingtargets7 has decided to implement their discount programs through a lot of shootingtargets7 coupon codes. Receive amazing discounts.',
            'extend_url' => [
                [
                    'title' => 'SAVE 45% Off Sitewide',
                    'description' => 'Use ShootingTargets7 Coupon Code now in order to get the discount of 45% Off Sitewide'
                ], [
                    'title' => 'Best Coupon code 2019',
                    'description' => 'Coupons Plus Deals has a source of coupons and deals provided by users and visitors daily.'
                ], [
                    'title' => 'Best sales 2019',
        ...
        'bbbd' => [
            'url' => 'https://www.bestbuybestdeals.com/shootingtargets7-coupons',
            'title' => '60% Off ShootingTargets7 Coupons, Discount Codes | Hurry up!',
            'description' => 'Enjoy 60% off - Redeem Your ShootingTargets7 Coupon Code Today | The latest ShootingTargets7 discount codes | Top Hand-Tested Coupons for you.'
        ],
        'mrt' => [
            'url' => 'https://couponmarathon.com/shootingtargets7-coupons',
            'title' => 'Big Sale with ShootingTargets7 coupons and promos| Up to 50% OFF',
            'description' => 'More of what you want, less of what you don\'t. They always bring many exclusive ShootingTargets7 Coupons coupon for customers when shopping online.'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/shootingtargets7-coupons',
            'title' => 'Verified ShootingTargets7 Coupon/Discount for up to 60% OFF!',
            'description' => 'Just gift for you today. Enter ShootingTargets7 coupon code at checkout to save 5% off on your order. This offer will expire soon. Show Code.'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/shootingtargets7-coupons',
            'title' => 'Hot Deal for all | 50% OFF with ShootingTargets7 Discount Codes',
            'description' => 'Get Up To 50% Off With Our New ShootingTargets7 Coupon Codes. Verified ShootingTargets7 Coupons & Deals Today! More Savings | Top Discounts.'
        ]
    ],
    'all-things-real-estate-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/all-things-real-estate-coupons',
            'title' => '90% Off All Things Real Estate Coupons & Promo Codes | 100% Valid',
            'description' => 'All Things Real Estate Coupons & Promo codes. Where to find All Things Real Estate coupon codes? Come to Coupon Plus Deals and get valid discounts.',
            'extend_url' => [
                [
                    'title' => '70% Off Coupon in February',
                    'description' => 'Top voted - Limited time Offer - Never miss out!'
                ], [
                    'title' => 'Happy Offer',
                    'description' => 'Adhesive Business Card Holder for only $0.75'
                ], [
                    'title' => '50% Off All Things Real Estate‎',
                    'description' => 'Best Deals. Exclusive Coupons. Coupon Codes. Big Discounts.'
                ], [
                    'title' => '2019 Promo Code',
                    'description' => 'Save 15% w/ 10 active All Things Real Estate Promo Codes and Sales'
                ],
            ]
        ],
        'bbbd' => [
            'url' => 'https://www.bestbuybestdeals.com/all-things-real-estate-coupons',
            'title' => '60% Off All Things Real Estate Coupons, Discount Codes and Deals!',
            'description' => '100% FREE All Things Real Estate coupon codes for up to 70% OFF are weekly updated here | Check out these All Things Real Estate best deals!'
        ],
        'mrt' => [
            'url' => 'https://couponmarathon.com/all-things-real-estate-coupons',
            'title' => 'Best All Things Real Estate Online Coupon codes | Take 60% OFF',
            'description' => 'Daily Updated | 100% Free All Things Real Estate Coupon codes at Coupon Marathon | Order Today and Get 60% OFF right now | Never miss this chance!'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/all-things-real-estate-coupons',
            'title' => 'Grab this exclusive 30% OFF with All Things Real Estate promo!',
            'description' => 'Why Pay more when you have the opportunity to get Up to 70% off for sale items only at All Things Real Estate without All Things Real Estate discount code!'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/all-things-real-estate-coupons',
            'title' => 'Take flat 20% OFF by using this All Things Real Estate coupon ',
            'description' => 'Be the first one to grab all amazing collection. With this exclusive All Things Real Estate promo, shop till your drop and enjoy the huge savings!'
        ]
    ],
    'modibodi-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/modibodi-coupons',
            'title' => '80% OFF Your Next Order with verified Modibodi Coupons here!',
            'description' => 'Get top products from Modibodi at afforable prices! Save as much money as you can with Modibodi discount codes, hot deals or special offers here! ',
            'extend_url' => [
                [
...
Save with coupon, discount & promo code'
                    ...
                    'description' => 'Experience major savings with 15% off on your purchase over $70'
                ], [
                    'title' => 'For New Customer',
                    'description' => 'New customer discount 10% Off Amazing code'
                ], [
                    'title' => 'Today Sale',
                    'description' => 'Extra 10% Off On All Your Purchase'
                ],
            ]
        ],
        'bbbd' => [
        ...
        'mrt' => [
            ...
            'title' => '40% OFF Modibodi Apparel, Underwear & Swimwear discount codes',
            'description' => 'Don\'t skip this chance to get top products from Modibodi at afforable prices. Discount | Promo Codes | Hot Deals | Special Offers | Free Shipping'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/modibodi-coupons',
            'title' => 'Modibodi Hot Sale Today! 50% OFF Everything with Modibodi Coupons',
            'description' => 'These hot deals won\'t last so long. Grasp Modibodi discounts, promo codes and great offers while you can to save your wallet! Don\'t let them go!'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/modibodi-coupons',
            'title' => 'Modibodi products at the lowest prices! 60% OFF Modibodi coupons!',
            'description' => 'Enjoy big savings with Modibodi discounts, promo codes, hot deals and special offers available here! What are you waiting for? Limited time offer!'
        ]
    ],
    'shytobuy-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/shytobuy-coupons',
            'title' => '70% Off shytobuy.co.uk Coupons & Promo Codes | January 2019 Deals',
            'description' => 'Everything is on sale at shytobuy.co.uk | Find and redeem ShytoBuy coupon codes and deals at Coupon Plus Deals | Special Deals. More Savings.',
            'extend_url' => [
                [
                    'title' => 'CouponsPlusDeals 2019',
...
Get it now'
        ...
        'mrt' => [
            ...
            'title' => 'Active 2019 ShytoBuy Promo Codes & Coupons for everyone | 60% OFF',
            'description' => '1-Click ShytoBuy Coupons at Coupon Marathon | Shop at shytobuy.co.uk with this 60% off discount code | Click to enjoy the best deal right now.'
        ],
        'cfs' => [
            'url' => 'https://www.couponsforsave.com/shytobuy-coupons',
            'title' => 'Must see! 50% OFF for all orders with ShytoBuy promo codes, deals',
            'description' => 'Find the latest ShytoBuy Discount Codes and promotions on Coupons For Save | Never miss a valid code for your next order | Don\'t Pay Full Price.'
        ],
        'cp' => [
            'url' => 'https://www.couponpublish.com/shytobuy-coupons',
            'title' => '60% OFF | 2019 ShytoBuy Promo Codes, Coupons, Free Gifts and more',
            'description' => 'Official and Verified ShytoBuy Discount Codes Found Here | Take advantage of free products and exclusive offers with Coupon Publish | Don\'t pass!'
        ]
    ],
    'visahq-coupons' => [
        'cpd' => [
            'url' => 'https://www.couponsplusdeals.com/visahq-coupons',
            'title' => 'Hot Deal | Receive 60% OFF by Using VisaHQ Coupon | Order today',
            'description' => 'Deal of the day | Up to 60% OFF | Enjoy incomparable quality, easy ordering, free shipping and best price with these VisaHQ promo codes and hot deals!',
            'extend_url' => [
                [
                    'title' => 'Best Coupons Site 2019',
                    'description' => 'Provied 100% working code
...
40% Off Your Order'
                    ...
                    'title' => 'Special Sales',
                    'description' => 'Receive 40% Off New Annual Subscriptions'
                ],
            ]
        ],
        'bbbd' => [
            'url' => 'https://www.bestbuybestdeals.com/visahq-coupons',
            'title' => 'VisaHQ coupon codes for up to 50% OFF | Verified & Tested Today!',
